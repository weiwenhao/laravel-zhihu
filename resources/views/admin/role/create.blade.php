                ...
                <div class="box-body">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="form-group {{ $errors->has('name')?'has-error':'' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control" id="inputError" placeholder="例:  admin">
                                @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('display_name')?'has-error':'' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="display_name" value="{{ old('display_name') }}" class="form-control" id="inputError" placeholder="例:  超级管理员">
                            ...
                            <div class="col-md-6">
                                @foreach($perms as $value)
                                    ...
                                    <input type="checkbox"
                                           ...
                                           name="perm_ids[]"
                                           value="{{ $value->id }}"
                                           {{ in_array($value->id, old('perm_ids',[]))?'checked':'' }}
                                    >
                                    {{ $value->display_name }}
                                    <br>
                                @endforeach
